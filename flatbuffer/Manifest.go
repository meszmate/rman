...
func ManifestAddBundles(builder *flatbuffers.Builder, bundles flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(bundles), 0)
}
...
func ManifestAddFileEntries(builder *flatbuffers.Builder, fileEntries flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(3, flatbuffers.UOffsetT(fileEntries), 0)
}
...
func ManifestAddDirectories(builder *flatbuffers.Builder, directories flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(4, flatbuffers.UOffsetT(directories), 0)
}
