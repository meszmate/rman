...
func (rcv *Language) MutateName(n int8) bool {
...
func LanguageAddName(builder *flatbuffers.Builder, name int8) {
	builder.PrependInt8Slot(1, name, 0)
}
