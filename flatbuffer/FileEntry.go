...
func (rcv *FileEntry) Chunks(j int) uint64 {
...
func (rcv *FileEntry) ChunksLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(14))
	if o != 0 {
...
func (rcv *FileEntry) MutateChunks(j int, n uint64) bool {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(14))
	if o != 0 {
		a := rcv._tab.Vector(o)
...
func FileEntryAddChunks(builder *flatbuffers.Builder, chunks flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(chunks), 0)
}
func FileEntryStartChunksVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
