...
func (rcv *Directory) DirectoryId() uint64 {
...
func (rcv *Directory) MutateDirectoryId(n uint64) bool {
...
func DirectoryAddDirectoryId(builder *flatbuffers.Builder, directoryId uint64) {
	builder.PrependUint64Slot(0, directoryId, 0)
}
