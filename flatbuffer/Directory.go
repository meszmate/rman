...
func (rcv *Directory) MutateId(n int64) bool {
	return rcv._tab.MutateInt64Slot(4, n)
}

func (rcv *Directory) ParentId() int64 {
...
func (rcv *Directory) MutateParentId(n int64) bool {
...
func DirectoryAddId(builder *flatbuffers.Builder, id int64) {
	builder.PrependInt64Slot(0, id, 0)
}
func DirectoryAddParentId(builder *flatbuffers.Builder, parentId int64) {
